...
<body>
  <h1 class="text-center">Reporte Ingreso de vehículos de hoy</h1>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        @if (count($vehiculosIn) == 0)
          <tr>
            <td colspan="6" class="text-center">Sin vehículos para hoy</td>
          </tr>
        @endif
  ...
  <br><br>
  <h1 class="text-center">Reporte Salida de vehículos de hoy</h1>
  <div class="container w-100" id="container">
    <table class="table table-striped">
      <thead>
        <tr>
